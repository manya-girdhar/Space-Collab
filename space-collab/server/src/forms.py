...
# Select field uses the format (index, value)
class ProjectForm(FlaskForm):
    project_title = StringField("Title", validators=[DataRequired(), Length(max=100)])
    ...
    theme = SelectField("Project Category", choices=[
            ("N/A", "N/A"),
            ("Exoplanets", "Exoplanets"),
            ("Human mission to Mars", "Human mission to Mars"),
            ("Theoretical Physics", "Theoretical Physics"),
            ("Dark Energy and Dark Matter", "Dark Energy and Dark Matter"),
            ("Quantum Mechanics", "Quantum Mechanics"),
            ("Search for Extraterrestrial Life", "Search for Extraterrestrial Life"),
